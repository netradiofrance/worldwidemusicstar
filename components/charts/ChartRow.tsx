...
export function ChartRow({ rank, track }: { rank: number; track: Track }) {
  ...
  return (
    <div
      className="chart-row grid grid-cols-[48px_64px_1fr_auto] sm:grid-cols-[64px_72px_1fr_repeat(3,minmax(80px,auto))_120px] items-center gap-3 sm:gap-4 px-3 sm:px-5 py-3 border-b border-white/5"
    >
      {/* Rank */}
